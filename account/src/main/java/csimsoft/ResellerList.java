...
public class ResellerList extends DatabasePageList
{
   ...
   {
      String baseLink = "selectreseller.jsp";
   ...
   public void setResults() throws SQLException
   {
      ...
      this.results = this.statement.executeQuery(
         ...
         "INNER JOIN distributors ON (users.userid = distributors.userid AND distributors.reseller = 1)" +
