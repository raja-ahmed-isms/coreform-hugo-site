...
public class DisableProductServlet extends HttpServlet
{
      ...
      public void setResult(int result)
      {
         ...
         if(result == ResultMessage.Success)
         {
            ...
            this.Report.setMessage(
               "The product has been removed from the user's download list.");
         }
         else if(result == ResultMessage.Failure)
         {
            this.Report.setType(ResultMessage.ErrorMessage);
            this.Report.setMessage(
               "Unable to remove the product from the user's download list.");
         }
         else if(result == ResultMessage.NotAuthorized)
         {
            this.Report.setType(ResultMessage.ErrorMessage);
            this.Report.setMessage(
               "You are not authorized to disable a product.<br />" +
      ...
      throws IOException, ServletException
   {
      ...
      DisableProductServlet.Message message = new DisableProductServlet.Message(
