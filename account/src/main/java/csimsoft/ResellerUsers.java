...
public class ResellerUsers extends DatabasePageList
{
   ...
   {
      String baseLink = "resellerusers.jsp?";
      if(this.IncludeId)
   ...
   public void setResults() throws SQLException
   {
      ...
      if(this.Search == null || this.Search.isEmpty())
      {
         ...
         this.results = this.statement.executeQuery(
            ...
            "WHERE groupid IN (SELECT groupid FROM distributors WHERE reseller = 1 AND userid = " +
