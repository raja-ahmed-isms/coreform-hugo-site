...
<head>
  ...
  <title>Coreform - New Trial</title>
    ...
    function validateNewClient() {
      ...
      if (askCompany) {
        if (stripAndValidateInput(document.signupform.company)) {
          if (confirm("The company field is empty. Please enter it if you\n" +
            "have one. Do you work for a company?")) {
...
<body onload="document.signupform.first.focus()">
  ...
  <div class="main">
   ...
   info.setCountry(request.getParameter("country")); %>
    <div class="content">
      <h2>Try Coreform Cubit free for 30 days</h2>
      ...
      <table class="center" cellpadding="0" cellspacing="0">
        <tr>
          <td>
            <form action="addusertrial" method="POST" name="signupform" accept-charset="UTF-8"
              ...
              <table class="inner" border="0" cellpadding="4" cellspacing="0">
                ...
                <tr>
                  <td><input type="text" placeholder="Company*" name="company" size="40"
                ...
                <tr>
                  <td style="color:#555">
                    <label for="ind_or_edu">License type: </label>
                    <select style="color:#555" id="ind_or_edu" name="ind_or_edu">
                      <option selected value="industry">Commercial</option>
                      <option value="education">Academic</option>
                    </select>
                    <select style="color:#555" id="ind_specific" name="ind_specific">
                      ...
                      <option value="government">Governmenet</option>
                      ...
                      <option value="reseller">Potential Reseller</option>
                      <option value="transportation">Transportation</option>
                      <option value="utilities">Utilities</option>
                    </select>
                    <select style="color:#555" hidden id="edu_specific" name="edu_specific">
                ...
                <tr>
                  <td style="text-align: left; padding-left: 23px; font-size: 15px; color:#555;">We'd like to include
                    ...
                    products.<br /><br /><input type="checkbox" name="opt-in" /> Yes, include me on the Coreform mailing
                    list.</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td class="center"><br /><input type="submit" value="Request trial" /></td>
                </tr>
      ...
      <div class="center">
        <p><span style="font-size: 15px">Already have an account?</span><br /><a href="index.jsp">Sign in</a></p>
      </div>
    </div>
