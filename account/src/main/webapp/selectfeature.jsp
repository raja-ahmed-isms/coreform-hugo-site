...
<title>Coreform - Select Feature</title>
...
function sendSelectFeatureForm(featureid)
{
  document.selectfeatureform.feature.value = featureid
  document.selectfeatureform.submit()
}
</script>
<% } %>
  ...
  <div class="main">
    ...
    <div class="navleft">
      <jsp:include page="navigation.jsp" flush="true" >
        <jsp:param name="current" value="selectfeature.jsp" />
      </jsp:include>
    </div>
...
<% if(isLoggedIn)
   {
    ...
    <div class="content">
      <table border="0" cellpadding="6" cellspacing="0" width="100%">
        <tr>
          <td class="title-cell" colspan="2">Select a Feature</td>
        </tr>
<%       int i = 0;
        ...
        <tr>
          <td class="list-icon">
            <img src="./images/icon-feature.png" width="20" height="20" />
          </td>
          <td class="list-row">
            <a href="javascript:sendSelectFeatureForm('<%= licenses.database.results.getInt("featureid") %>')">
            <%= licenses.database.results.getString("featurename") %></a>
          </td>
        </tr>
<%       }
        ...
        <tr>
          ...
          There are no features in the database.
          </td>
        </tr>
<%       }
