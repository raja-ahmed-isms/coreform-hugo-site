...
<title>Coreform - All Platforms</title>
  ...
  <div class="main">
    ...
    <div class="navleft">
      <jsp:include page="navigation.jsp" flush="true" >
        <jsp:param name="current" value="allplatforms.jsp" />
      </jsp:include>
    </div>
...
<% if(isLoggedIn)
   {
    ...
    <div class="content">
      <table border="0" cellpadding="6" cellspacing="0" width="100%">
        ...
        <tr>
          <td class="title-cell" colspan="2">Platforms</td>
        </tr>
<%       int i = 0;
         for( ; licenses.database.results.next(); i++)
         {
           int platformId = licenses.database.results.getInt("platformid");
           String platformName = licenses.database.results.getString("platformname"); %>
        <tr>
          <td class="list-icon">
            <a href="javascript:sendDeletePlatformForm(<%= platformId %>, '<%= platformName.replace("'", "\\'") %>')"
              ><img src="./images/icon-delete.jpg" width="20" height="20" /></a>
          </td>
          <td class="list-row">
            <a href="platforminfo.jsp?platform=<%= platformId %>"><%= platformName %></a>
          </td>
        </tr>
<%       }
        ...
        <tr>
          <td class="list-row" colspan="2">
            There are no platforms in the database.
          </td>
        </tr>
<%       } %>
        <tr>
          <td colspan="2">
            <form action="removeplatform" method="POST" name="deleteplatformform">
