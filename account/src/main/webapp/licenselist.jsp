...
<%           } %>
      ...
      <tr>
        <td class="list-row" colspan="5">
          ...
          <ol>
            ...
            <li>
              Wait for the client to pay for the license(s). After you have received
              payment for this order, click the "Finish" button below.
            </li>
          </ol>
        </td>
      </tr>
      <tr>
        <td colspan="5" align="right">
          <form action="addorderstep" method="POST" name="finishorderform">
            <input type="hidden" name="orderid" value="<%= orderId %>" />
